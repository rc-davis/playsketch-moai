...
model.datastructure = {}
model.datastructure.all_objects = {}
model.datastructure.keys = {TRANSLATION=1, ROTATION=2, SCALE=3}


-- addObject(o): Adds all of the state and functions to o to track lists of time-information
function model.datastructure.addObject(o, modeltable)

	model.datastructure.all_objects[o] = o
...
function model.datastructure.deleteObject(o)
	model.datastructure.all_objects[o] = nil
end

return model.datastructure
